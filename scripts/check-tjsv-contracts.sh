...
local_declarations='["Ores.LocksAndLeases.LocalFile.LocalFileLockErrorKind","Ores.LocksAndLeases.LocalFile.LocalFileLockFailure","Ores.LocksAndLeases.LocalFile.LocalFileLockIdentity","Ores.LocksAndLeases.LocalFile.LocalFileLockInspection","Ores.LocksAndLeases.LocalFile.LocalFileLockInspectionState","Ores.LocksAndLeases.LocalFile.LocalFileLockOptions","Ores.LocksAndLeases.LocalFile.LocalFileLockOwner","Ores.LocksAndLeases.LocalFile.LocalFileLockPath","Ores.LocksAndLeases.LocalFile.LocalFileLockRecoveryRequest","Ores.LocksAndLeases.LocalFile.LocalFileLockRecoveryResult","Ores.LocksAndLeases.LocalFile.LocalFileLockSnapshot","Ores.LocksAndLeases.LocalFile.ScopedLocalFileLockOutcome","Ores.LocksAndLeases.LocalFile.ScopedLocalFileLockOutcomeKind"]'
config_declarations='["Ores.LocksAndLeases.Config.CloudflareDurableObjectProviderConfig","Ores.LocksAndLeases.Config.EnvBinding","Ores.LocksAndLeases.Config.EnvKey","Ores.LocksAndLeases.Config.EnvKind","Ores.LocksAndLeases.Config.FiduciaProviderConfig","Ores.LocksAndLeases.Config.LocalFileProviderConfig","Ores.LocksAndLeases.Config.LockConfigSchemaVersion","Ores.LocksAndLeases.Config.LockProfileConfig","Ores.LocksAndLeases.Config.LockProfileId","Ores.LocksAndLeases.Config.OresLockConfigV1","Ores.LocksAndLeases.Config.OuterLeaseAuthority","Ores.LocksAndLeases.Config.PostgresLockScope","Ores.LocksAndLeases.Config.PostgresProviderConfig","Ores.LocksAndLeases.Config.ProviderSelection","Ores.LocksAndLeases.Config.RedisProviderConfig"]'
